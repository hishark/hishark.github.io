...
那我问一个问题啊，比如说你在同步过程中，比如说无网了，怎么办，你有考虑过这个问题吗

比如说你传输的这个文件一般有多大呀

比如说你这个是一张一张传呢，还是打包传呢

比如说你照了很多张怎么办，就一张一张传？

那你这个是怎么设计的？里边是用线程池呢，还是队列呢，还是怎么样做的呀

那你这个线程池怎么实现，具体代码是怎么写的？

那比如说你在同步上传这个逻辑中肯定涉及到耗 cpu 的嘛，那么如何保证你的前端页面不卡顿呢

如果安卓的话，你在子线程里做完之后，你要同步给主线程的话，是如何同步的

Handler 具体的源代码有读过吗，讲一讲你具体学到了什么呢

第二个是你用自定义view去做了一个功能对吧，那如何自定义view呢

我看你好像参加了一个什么竞赛是吧，全国大学生物联网竞赛，是做了个什么东西呢？

我看你有用到了一个图表库是吧，你是用这个来绘制图形吗还是干嘛呢

那你用这个图标库的时候有没有研究过一些安卓在绘图上面的原理呢，比如说 openGL 呀，这些东西，都有接触过吗

那你在做安卓的过程中，有没有遇到一些性能上的问题

有没有遇到过 OOM 呀

我问一道算法题啊，比如说有一个二叉树，给定前序遍历和中序遍历，怎么重新构建这个二叉树
